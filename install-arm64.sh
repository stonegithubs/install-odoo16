...
sudo wget http://launchpadlibrarian.net/475575244/libssl1.1_1.1.1f-1ubuntu2_arm64.deb
sudo dpkg -i libssl1.1_1.1.1f-1ubuntu2_arm64.deb
sudo wget https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6-1/wkhtmltox_0.12.6-1.focal_arm64.deb
sudo chmod +x wkhtmltox_0.12.6-1.focal_arm64.deb
sudo apt install ./wkhtmltox_0.12.6-1.focal_arm64.deb -y
